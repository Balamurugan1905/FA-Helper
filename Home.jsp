...
<body>
  ...
  <nav>
    ...
    <div class="sidebar">
      <img src="image?id=${ student.Name}" />
     
      <div class="details">
        <h3><%=rs.getString("StudentName")%></h3>
      ...
      <tbody>
        ...
        <%
    		...
    		try {
        		...
        		conn = DriverManager.getConnection(url, username, password);
        		stmt = conn.createStatement();
        		String sql = "SELECT * FROM feesdetails where RegisterNumber = '"+orgnum+"'";
        		rs = stmt.executeQuery(sql);        
        ...
        <tr>
          ...
          <td><%= rs.getInt("YearI") %></td>
          <td><%= rs.getInt("YearII") %></td>
          <td><%= rs.getString("YearIII") %></td>
        </tr>
        <%
                  }
    		} catch (Exception e) {
		...
		%>
        <tr class="white">
          <td class="back">Status</td>
          <td border="4">
            <p id="incm">Incomplete</p>
          </td>
          <td>
            <p id="war">Incomplete</p>
          </td>
          <td>
            <p id="cm">Complete</p>
          </td>
