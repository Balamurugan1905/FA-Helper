...
<%
	try{
		...
		ResultSet rs = statement.executeQuery("select * from studetails;");
		while(rs.next()){ %>
		<tr>
		...
		<td><%=rs.getString("Father Name") %></td>
		<td><%=rs.getString("Mother Name")%></td>
		<td><%=rs.getString("Address")%></td>
		<td><%=rs.getString("Mobile Number")%></td>
		</tr>	
		<% }
...
%>
    ...
    <header>
        <nav class="navbar">
            ...
            <a href="#" class="logo">
                <img src="falogo.jpg" alt="logo">
                <h2>FA HELPER</h2>
            </a>
            <ul class="links">
                <span class="close-btn material-symbols-rounded">close</span>
             </ul>
            <button class="login-btn">LOG IN</button>        </nav>
    </header>
